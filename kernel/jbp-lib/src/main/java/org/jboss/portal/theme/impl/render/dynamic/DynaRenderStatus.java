...
public class DynaRenderStatus
{
   ...
   {
      Boolean active = (Boolean)rendererContext.getAttribute(DynaConstants.RENDER_STATUS);
   ...
   {
      rendererContext.setAttribute(DynaConstants.RENDER_STATUS, Boolean.valueOf(active));
   }

/* Cette classe a été modifiée pour intégrer le processus de migration au déploiement
du portlet administration

Cela a surtout été fait pour trouver un moyen de modifier les classes qui font de l'aop
*/

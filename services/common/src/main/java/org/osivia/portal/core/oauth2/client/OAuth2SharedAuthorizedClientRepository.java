 ...
 * {@link OAuth2AuthorizedClient}'s in a common repository
 *
 * @author jssteux
 ...
 */
public final class OAuth2SharedAuthorizedClientRepository implements OAuth2AuthorizedClientRepository {

	
	Map<String, OAuth2AuthorizedClient> authorizedClients = new ConcurrentHashMap<>();
